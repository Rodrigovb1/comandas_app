// lista todos os endereços da API num lugar só, pra não ficar escrevendo /funcionario/ espalhado por
// todo o projeto. Quando precisar chamar a API em qualquer tela, importamos daqui.

// Configuração da API com variáveis de ambiente VITE
...
const API_ENDPOINTS = {
    ...
    PRODUTO: {
        PUBLIC: '/produto/publico', // GET - listar produtos publicos
