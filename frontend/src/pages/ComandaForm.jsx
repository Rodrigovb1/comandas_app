...
const ComandaForm = () => {
    ...
    const { control, handleSubmit, formState: { errors, dirtyFields }, reset, setError, clearErrors } = useForm({
        defaultValues: {
            comanda: '',
            data_hora: getCurrentLocalDateTimeInputValue(),
            cliente_id: '',
        ...
        const loadComanda = async () => {
            if (id && id !== 'new') {
                try {
                    ...
                    if (data.data_hora) {
                        data.data_hora = toDateTimeInputValue(data.data_hora);
                    }
                    reset(data);
                } catch (error) {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            const comandaData = {
                ...
                data_hora: id && id !== 'new' ? data.data_hora : getCurrentLocalDateTimeInputValue(), // Usar data atual local para novas comandas
